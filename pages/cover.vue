import { LearnMore } from '../.nuxt/components';
<template>
    <div id="app">
        <Navbar />
        <div id="container">
            <div id="header">
                <h1>Hyun Jaeyeon</h1>
                <div>Music Composer, Arranger, Producer, Engineer</div>
            </div>
            <div id="news">
                <h2>Cover</h2>
                <div class="content">
                    ...
                    <ul>
                        <li>대리암 (Origin: Doctors) <code>K-Pop</code>
                            <iframe width="100%" style="aspect-ratio: 16 / 9" src="https://www.youtube.com/embed/d8SAQNtTJyc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </li>
                    </ul>
                </div>
                <div class="content">
                    ...
                    <ul>
                        <li>イイじゃん (Origin: M!LK) <code>J-Pop</code>
                            <iframe width="100%" style="aspect-ratio: 16 / 9" src="https://www.youtube.com/embed/gBOO_SsR17k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </li>
                    </ul>
                </div>
                <div class="content">
...
#header {
    background-image: url('https://images.pexels.com/photos/2102907/pexels-photo-2102907.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2');
